...
def pytest_terminal_summary(terminalreporter, exitstatus, config):
    if NOGIL_BUILD and not gil_enabled_at_start and sys._is_gil_enabled():
        ...
        tr.xline("The GIL was re-enabled at runtime during the tests.")
        tr.xline("This can happen with no test failures if the RuntimeWarning")
        tr.xline("raised by Python when this happens is filtered by a test.")
        tr.xline("")
        tr.xline("Please ensure all new C modules declare support for running")
        tr.xline("without the GIL. Any new tests that intentionally imports ")
        tr.xline("code that re-enables the GIL should do so in a subprocess.")
