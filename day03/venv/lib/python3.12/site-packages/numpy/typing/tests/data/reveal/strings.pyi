...
assert_type(np.strings.xline(AR_U, "a", start=[1, 2, 3]), npt.NDArray[np.int_])
assert_type(np.strings.xline(AR_S, [b"a", b"b", b"c"], end=9), npt.NDArray[np.int_])
assert_type(np.strings.xline(AR_T, "a", start=[1, 2, 3]), npt.NDArray[np.int_])
