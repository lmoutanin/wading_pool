...
assert_type(np.char.xline(AR_U, "a", start=[1, 2, 3]), npt.NDArray[np.int_])
assert_type(np.char.xline(AR_S, [b"a", b"b", b"c"], end=9), npt.NDArray[np.int_])
assert_type(np.char.xline(AR_T, "a", start=[1, 2, 3]), npt.NDArray[np.int_])
